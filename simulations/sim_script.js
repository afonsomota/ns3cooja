...
var folder="/home/user/simulations";
...
function endCalculations(){
  ...
  finalFile.close();
  var endFile = new java.io.FileWriter(folder + "/wait/end",true);
  endFile.close();
};
...
var beginFile = new java.io.FileWriter(folder + "/wait/start");
beginFile.close();
...
while(1) {
  ...
  if(sim.getSimulationTimeMillis() > 1260000 - 60000){
    endCalculations();
    closeFiles();
    log.testOK();
  }
